...
function HomepageAdmin() {
    ...
    if(whatToDo === 'addclassroom')
    {
        content = (
            ...
            <button type="button" onClick={() => addclassroom()} className='bookclass'>Submit</button>
            </form>
        )
    }
    else if(whatToDo === "removeclassroom")
    {
        content = (
            ...
            <button type="button" className='bookclass'  onClick={() => removeClassroom()}>Submit</button>
            </form>
        )
    }
    else if(whatToDo === 'removeteacher')
    {
        content = (
            ...
            <button type="button" className='bookclass' onClick={() => removeteacher()}>Submit</button>
            </form>
        )
    }
